...
def settings_argparse():
    ...
    parser.add_argument("--mode", help="It can be chosen calculation, parameterization, comparison, statistics, "
                                       "make_complete_html, parrameterization_find_args, "
    ...
    parser.add_argument("--method_parameterization",
                        help="It can be chosen minimize or diferential_evolution.",
                        choices=("minimize", "diferential_evolution"))
    ...
    if args.mode == "calculation":
        ...
        if args.charges is None or args.sdf_input is None or args.clusters is None \
                or args.atom_type_for_clusterize is None:
            parser.error("For clusterization must be choisen --charges, --sdf_input, --atom_type_for_clusterization "
                         "and --clusters!")
    elif args.mode == "statistics":
