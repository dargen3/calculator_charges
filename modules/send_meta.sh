...
ssh dargen3@tarkil.grid.cesnet.cz "cd calculator_charges/para_submit; ./para_submit.sh $PARA $SDF $CHG $date $5 \"${4}\" -l select=1:ncpus=$5:mem=$(($5*5))gb:scratch_local=$5gb -l walltime=$6:00:00"
