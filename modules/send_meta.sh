...
ssh dargen3@tarkil.grid.cesnet.cz "cd calculator_charges/para_submit; ./para_submit.sh $PARA $SDF $CHG $date \"${4}\" -l select=1:ncpus=1:mem=2gb:scratch_local=2gb -l walltime=100:00:00"
